                        ...
                        children: [
                            {
                                ...
                                name: '素材管理',
                                icon: 'stats-bars',
                                component: _import('public/scientificChildRearing/material'),
                                hidden: false,
                            },
                            {
                                path: 'user',
                            ...
                            },
                            {
                                ...
                                name: '标签管理',
                                icon: 'stats-bars',
                                component: _import('public/scientificChildRearing/tab'),
                            },
                            {
                                path: 'message',
                                name: '消息管理',
                                icon: 'stats-bars',
                                component: _import('public/scientificChildRearing/message'),
                            },
                            {
                                path: 'redPacket',
                                name: '发送红包',
                                icon: 'stats-bars',
                                component: _import('public/scientificChildRearing/redPacket'),
                            },
                            {
                                path: 'customMenu',
                                name: '自定义菜单管理',
                                icon: 'stats-bars',
                                component: _import('public/scientificChildRearing/customMenu'),
                            },
                        ]
                    },
                    {
                        path: 'tangChildRearing',
                        name: '堂妈家庭育儿',
                        icon: 'arrow-graph-up-right',
                        component: {
                            render(c) {
